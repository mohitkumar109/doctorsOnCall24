...
import AssignStore from "../pages/admin/storeInventory/AssignStore";
...
export default function AdminRoutes() {
    return (
        <Routes>
            ...
            <Route path="/add-store-inventory/:id" element={<AssignStore />} />

            <Route path="/store-history/" element={<AssignStoreHistory />} />
